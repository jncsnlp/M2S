...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str,
        ...
        #list_data_dict=mixgen(list_data_dict)
...
def train():
    ...
    print(training_args.bits)
    print(model_args.vision_tower)
    print(model_args.model_name_or_path)
    print(training_args.device)
    #print(hasattr(model, "enable_input_require_grads"))
    ...
    #print("lora_r",training_args.lora_r)
    #print(find_all_linear_names(model))
    #print(lora_dropout=training_args.lora_dropout)
    #print(training_args.lora_bias)
    ...
    if list(pathlib.Path(training_args.output_dir).glob("checkpoint-*")):
        ...
        trainer.train()
    trainer.save_state()
    #data_dev = make_supervised_data_dev(tokenizer=tokenizer,
    #                                          data_args=data_args)
    '''args = type('Args', (), {
        "model_path": model_path,
        "model_base": None,
        "model_name": get_model_name_from_path(model_path),
        "query": prompt_texts[i],
        "conv_mode": None,
