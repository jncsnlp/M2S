...
deepspeed /home/jncsnlp/lxf/mPLUG-Owl/mPLUG-Owl2/mplug_owl2/train/train_mem.py \
    --lora_enable True --lora_r 128 --lora_alpha 256 --visual_abstractor_lr 2e-5 \
    --deepspeed zero3.json \
    --model_name_or_path /home/jncsnlp/lxf/mPLUG-Owl2 \
    --version v1 \
    --data_path /home/jncsnlp/lxf/few-shot-data/mvsa-s/few-shot1.json \
